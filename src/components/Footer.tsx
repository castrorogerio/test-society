        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:flex md:justify-end">
            <div>
              ...
              <a
                href="https://www.instagram.com/testsociety.conf/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[#f4a82e] transition-colors"
                aria-label="Visit Test Society on Instagram"
              >
              ...
              <a
                href="https://www.linkedin.com/company/testsociety/posts/?feedView=all"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[#f4a82e] transition-colors"
                aria-label="Visit Test Society on LinkedIn"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
